...
public class PlayBoard extends javax.swing.JFrame {
    ...
    static Field startField = null;
    static Field targetField = null;
...
//<editor-fold defaultstate="collapsed" desc="Variables declaration of gui objects">
...
//</editor-fold>
    ...
    //TODO ja wird noch benötigt. Habe keine Möglichkeit gefunden mit String fXY das JLabel fXY anzusprechen. Daher immer Entnahme des Labels bei Koordinaten aus dem Field. <TM>
    /*
     * Writes labels of the gamepanel into an array for later use. Only used
     * once at start.
     */
    ...
    /*
     * Called by click on actionbutton. Checks current gamestate ..... blarr
     */
    ...
    /*
     * Uptades placement counter labels.
     */
    ...
    /*
     * Reads pieces from board in current game and sets icon of corresponding
     * field.
     */
    ...
    /*
     * Sets the borders of all game fields to null.
     */
    ...
    /*
     * Marks fields, which can be reached by the piece on given field, with
     * bordertype, set in constant "highlighted". Shows error message, if list
     * of reachable fields is empty and clears startField, that another field
     * can be selected.
     */
    public void highlightReachableFields(Field field) {
    ...
    /*
     * Returns true, if given piece-type is in list of left pieces of player
     * with move.
     */
    public boolean placeable(Piece piece) {
        int leftNumberOfPiece = game.gameState.getPlayerWithMove().getLeftNumberOfPieceInList(piece);
        if (leftNumberOfPiece > 0) {
            return true;
        } else {
            return false;
        }
    ...
    /*
     * Returns true, if a winner is found in current game.
     */
    public boolean winnerFound() {
        if (game.gameState.getCurrentGamephase().equals(jstratego.logic.game.GamephaseEnum.END)) {//TODO macht man das so? mit jstratego. ...
            return true;
        } else {
            return false;
        }
    ...
    //TODO rewrite comment
    /*
     * Decides by current gamestate and name of given field what to do.
     */
    public void movement(JLabel field) {
        ...
        if ((game.gameState.getCurrentGamephase() == jstratego.logic.game.GamephaseEnum.SETUPblue)
             ...
             *
             */
            if ((!(field.getName().length() == 3) || (field.getName().startsWith("S"))) && startField == null) {
